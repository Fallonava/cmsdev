...
import { BookOpen, Laptop, Microscope, Music, Code, Globe, Medal, Star } from "lucide-react";
    ...
    <main className="flex flex-col min-h-screen bg-[#fbfbfd] overflow-hidden">
      ...
      <section className="relative w-full pt-40 pb-20 px-4 sm:px-6">
        ...
        >
          ...
          <h1 className="text-5xl sm:text-6xl md:text-[5rem] font-extrabold text-gray-900 leading-[1.05] tracking-tighter">
            Ekselensi Kurikulum. <br className="hidden md:block"/>
            Sains Terapan & Ilmu Agama.
          </h1>
          <p className="text-xl md:text-2xl text-gray-500 font-medium max-w-3xl mt-4 leading-relaxed">
            Menyelaraskan standar pendidikan nasional dengan nilai-nilai luhur Kemuhammadiyahan untuk mencetak pemimpin masa depan.
          </p>
        </motion.div>
      </section>
          ...
          >
            ...
            <div className="w-full md:w-1/2 flex flex-col gap-6 relative z-10">
              ...
              <h2 className="text-4xl sm:text-5xl font-extrabold text-white leading-tight tracking-tight">
                Program <br className="hidden md:block"/> Tahfidz Unggulan
              </h2>
              <p className="text-xl text-gray-400 leading-relaxed font-medium">
                Metode hafalan intensif namun menyenangkan. Didampingi oleh Hafidz/Hafidzah bersertifikat untuk memastikan tartil dan tajwid yang sempurna.
              </p>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-500 text-lg font-medium max-w-md leading-relaxed">
                  Semua ruang kelas dilengkapi dengan proyektor interaktif dan fasilitas WiFi untuk mendukung riset siswa langsung dari meja belajar.
                </p>
              </div>
            </motion.div>
            ...
            >
              <div className="relative z-10">
                ...
                <div className="flex flex-wrap gap-4">
                  {[
                    { name: "Tapak Suci", icon: Medal },
                    { name: "Hizbul Wathan", icon: Globe },
                    { name: "Robotika", icon: Code },
                    { name: "Seni Musik Islami", icon: Music }
                  ].map((eks, i) => (
                    <div key={i} className="flex items-center gap-2 px-5 py-3 rounded-full bg-white text-gray-800 font-bold shadow-sm border border-gray-100 hover:-translate-y-1 transition-transform cursor-default">
                      <eks.icon size={18} className="text-primary" /> {eks.name}
                    </div>
                  ))}
                </div>
              </div>
